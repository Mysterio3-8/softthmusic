...
публикаций в сутки. 1440 / 18 = 80 мин, поэтому 60 разводит всех с запасом и оставляет
место на повторные попытки. Растёт число публикаций — зазор надо СНИЖАТЬ, иначе софты
начнут упираться: 24 публикации уже требуют 60 ровно, без запаса.
